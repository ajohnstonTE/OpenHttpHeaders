...
import com.techempower.openhttpheaders.wip.Rfc7231
import io.kotest.core.spec.style.FunSpec
import io.kotest.datatest.withData
import io.kotest.matchers.shouldBe

class NewAcceptHeaderGrammarTest : FunSpec({
  context("should parse successfully") {
    ...
    withData(
      ...
      Rfc7231.parseAcceptHeader(
          it.header,
          it.qValueKey
      ).mediaTypes shouldBe it.expected
    }
  }
  test("single media types should be parsed correctly") {
    Rfc7231.parseMediaType("text/html") shouldBe MediaType(
        type = "text",
        subtype = "html"
    )
  }
